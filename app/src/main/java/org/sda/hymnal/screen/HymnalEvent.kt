...
sealed interface HymnalEvent {
    ...
    data class AddHymnToPlaylist(val hymnPair: Pair<Hymn, PlaylistHymn?>, val playlist: Playlist) :
        HymnalEvent

    data class RemoveHymnFromPlaylist(
        val hymnPair: Pair<Hymn, PlaylistHymn?>,
        val playlist: Playlist
    ) : HymnalEvent

    data class MoveHymnInPlaylist(
        val hymnPair: Pair<Hymn, PlaylistHymn?>,
        val playlist: Playlist,
        val moveBy: Int
    ) : HymnalEvent
    ...
    data class PerformSearch(val query: String) : HymnalEvent
